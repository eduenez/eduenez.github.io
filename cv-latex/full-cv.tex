...
\cvevent{Research Consultant}{Gibran.ai (AI startup; seed funding from Together Fund)}{2025 -- 2026}{Full-time research consulting, June-December 2025 and again May-August 2026 (between UTSA semesters).}
...
\item Peter G. Casazza, Eduardo Due\~{n}ez, Jos\'e N. Iovino. \emph{Nondefinability of the spaces of Tsirelson and Schlumprecht} (In press; scheduled to appear in print October 2026.)
...
{\footnotesize
\begin{itemize}
\item Facultad de Estudios Superiores Acatlán, UNAM, May 22, 2026 (also given in Spanish, same date/venue, as ``Complejidad de cómputos profundos'').
  \emph{Complexity of Deep Computations via Topology of Function Spaces.}
...
{\footnotesize
\begin{itemize}
\item\emph{Opening the ``Black Box'': From Linear Regression to ChatGPT in 60 Minutes.} Universidad Panamericana, 21 May 2026.
...
\item[Fall 2026] Modern Abstract Algebra
\item[Fall 2026] Algebra I*
